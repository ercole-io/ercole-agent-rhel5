...
steps: [
    { type: 'restore_workspace', dest_dir: '.' },
    {
      ...
      command: |||
          cd dist
          GH_REPO="https://api.github.com/repos/${GITHUB_USER}/ercole-agent-rhel5/releases"
          if [ ${AGOLA_GIT_TAG} ];
          ...
          for filename in *; do
            REPO_ASSET="https://uploads.github.com/repos/${GITHUB_USER}/ercole-agent-rhel5/releases/$id/assets?name=$(basename $filename)"
